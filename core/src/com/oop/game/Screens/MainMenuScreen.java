...
import com.oop.game.Animation.BaseActor;
...
//    }
    ...
    public MainMenuScreen(BaseGame g) {
        super(g);
    }
    ...
    public void create() {
        ...
        titleText.setTexture (new Texture((Gdx.files.internal("playbutton.png"))));
        titleText.setPosition(90, 175);
        titleText.scaleBy(1f);
